											...
											<td class="product-thumbnail">
												<div class="product-thumbnail-wrapper">
													...
													<a href="shop-product-sidebar-right.html" class="product-thumbnail-image" title="Photo Camera">
														<img width="90" height="90" alt="" class="img-fluid" src="./assets/user/img/products/product-grey-1.jpg">
													</a>
												</div>
											</td>
											...
											<td class="product-thumbnail">
												<div class="product-thumbnail-wrapper">
													...
													<a href="shop-product-sidebar-right.html" class="product-thumbnail-image" title="Porto Headphone">
														<img width="90" height="90" alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7.jpg">
													</a>
												</div>
											</td>
											<td class="product-name">
											...
											<td class="product-thumbnail">
												<div class="product-thumbnail-wrapper">
													...
													<a href="shop-product-sidebar-right.html" class="product-thumbnail-image" title="Golf Bag">
														<img width="90" height="90" alt="" class="img-fluid" src="./assets/user/img/products/product-grey-2.jpg">
													</a>
												</div>
											</td>
											<td class="product-name">
											...
											<td class="product-thumbnail">
												<div class="product-thumbnail-wrapper">
													...
													<a href="shop-product-sidebar-right.html" class="product-thumbnail-image" title="Workout">
														<img width="90" height="90" alt="" class="img-fluid" src="./assets/user/img/products/product-grey-3.jpg">
													</a>
												</div>
											</td>
											<td class="product-name">
											...
											<td class="product-thumbnail">
												<div class="product-thumbnail-wrapper">
													...
													<a href="shop-product-sidebar-right.html" class="product-thumbnail-image" title="Luxury Bag">
														<img width="90" height="90" alt="" class="img-fluid" src="./assets/user/img/products/product-grey-4.jpg">
													</a>
												</div>
											</td>
											<td class="product-name">
								...
								<div class="owl-carousel owl-theme nav-style-1 nav-outside nav-outside nav-dark mb-0" data-plugin-options="{'loop': false, 'autoplay': false, 'items': 4, 'nav': true, 'dots': false, 'margin': 20, 'autoplayHoverPause': true, 'autoHeight': true, 'stagePadding': '75', 'navVerticalOffset': '50px'}">
									...
									<div class="product mb-0">
										<div class="product-thumb-info border-0 mb-3">
											...
											<a href="./assets/user/ajax/shop-product-quick-view.html" class="quick-view text-uppercase font-weight-semibold text-2">
												QUICK VIEW
											</a>
