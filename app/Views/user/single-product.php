					...
					<div class="col-md-5 mb-5 mb-md-0">
						...
						<div class="thumb-gallery-wrapper">
							<div class="thumb-gallery-detail owl-carousel owl-theme manual nav-inside nav-style-1 nav-dark mb-3">
								<div>
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7.jpg" data-zoom-image="./assets/user/img/products/product-grey-7.jpg">
								</div>
								<div>
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7-2.jpg" data-zoom-image="./assets/user/img/products/product-grey-7-2.jpg">
								</div>
								<div>
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7-3.jpg" data-zoom-image="./assets/user/img/products/product-grey-7-3.jpg">
								</div>
								<div>
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7-4.jpg" data-zoom-image="./assets/user/img/products/product-grey-7-4.jpg">
								</div>
								<div>
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7-5.jpg" data-zoom-image="./assets/user/img/products/product-grey-7-5.jpg">
								</div>
							</div>
							<div class="thumb-gallery-thumbs owl-carousel owl-theme manual thumb-gallery-thumbs">
								<div class="cur-pointer">
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7.jpg">
								</div>
								<div class="cur-pointer">
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7-2.jpg">
								</div>
								<div class="cur-pointer">
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7-3.jpg">
								</div>
								<div class="cur-pointer">
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7-4.jpg">
								</div>
								<div class="cur-pointer">
									<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-7-5.jpg">
								</div>
							</div>
						</div>
								...
								<div class="tab-pane px-0 py-3" id="productReviews">
									<ul class="comments">
										<li>
											<div class="comment">
												<div class="img-thumbnail border-0 p-0 d-none d-md-block">
													<img class="avatar rounded-circle" alt="" src="./assets/user/img/avatars/avatar-2.jpg">
												</div>
										...
										<li>
											<div class="comment">
												<div class="img-thumbnail border-0 p-0 d-none d-md-block">
													<img class="avatar rounded-circle" alt="" src="./assets/user/img/avatars/avatar.jpg">
												</div>
												<div class="comment-block">
													<div class="comment-arrow"></div>
													<span class="comment-by">
								...
								<div class="owl-carousel owl-theme nav-style-1 nav-outside nav-outside nav-dark mb-0" data-plugin-options="{'loop': false, 'autoplay': false, 'items': 4, 'nav': true, 'dots': false, 'margin': 20, 'autoplayHoverPause': true, 'autoHeight': true, 'stagePadding': '75', 'navVerticalOffset': '50px'}">
										...
										<div class="product-thumb-info border-0 mb-3">
											...
											<a href="shop-product-sidebar-left.html">
												<div class="product-thumb-info-image">
													<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-1.jpg">
									...
									<div class="product mb-0">
										<div class="product-thumb-info border-0 mb-3">
											...
											<a href="shop-product-sidebar-left.html">
												<div class="product-thumb-info-image">
													<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-2.jpg">
									...
									<div class="product mb-0">
										<div class="product-thumb-info border-0 mb-3">
											...
											<a href="shop-product-sidebar-left.html">
												<div class="product-thumb-info-image">
													<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-3.jpg">
									...
									<div class="product mb-0">
										<div class="product-thumb-info border-0 mb-3">
											...
											<a href="shop-product-sidebar-left.html">
												<div class="product-thumb-info-image">
													<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-4.jpg">
									...
									<div class="product mb-0">
										<div class="product-thumb-info border-0 mb-3">
											...
											<a href="shop-product-sidebar-left.html">
												<div class="product-thumb-info-image">
													<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-5.jpg">
									...
									<div class="product mb-0">
										<div class="product-thumb-info border-0 mb-3">
											...
											<a href="shop-product-sidebar-left.html">
												<div class="product-thumb-info-image">
													<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-6.jpg">
									...
									<div class="product mb-0">
										<div class="product-thumb-info border-0 mb-3">
											...
											<a href="shop-product-sidebar-left.html">
												<div class="product-thumb-info-image">
													<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-8.jpg">
									...
									<div class="product mb-0">
										<div class="product-thumb-info border-0 mb-3">
											...
											<a href="shop-product-sidebar-left.html">
												<div class="product-thumb-info-image">
													<img alt="" class="img-fluid" src="./assets/user/img/products/product-grey-9.jpg">
